...
const Dashboard = () => {
  ...
  const ventasRecientes = [
    { id: 101, cliente: "Carlos Mendoza", productos: 3, total: 1299.99, fecha: "2023-11-15", estado: "Completado" },
  ...
  const renderContent = () => {
    switch (activeSection) {
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-900 rounded-xl p-6 shadow-lg">
              <div className="flex justify-between items-center mb-4">
                ...
                <button className="text-red-500 hover:text-red-400 text-sm font-medium">Ver todos</button>
              </div>
                  ...
                  <tbody className="divide-y divide-gray-700">
                    {ventasRecientes.map((venta) => (
                      <tr key={venta.id} className="hover:bg-gray-800">
                        ...
                        <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-300">${venta.total.toLocaleString()}</td>
      ...
      case 'products':
        return <h2 className="text-2xl font-bold text-white">Gestión de Productos</h2>;
      case 'customers':
      ...
      case 'brands':
        return <h2 className="text-2xl font-bold text-white">Gestión de Marcas</h2>;
      case 'settings':
    ...
    <div className="flex h-screen bg-black text-white">
      ...
      <div className="w-64 bg-gray-900 shadow-lg">
        ...
        <div className="relative  h-16 ">
          <span className="font-ka1 text-center text-2xl text-white">Los miserables</span>
          </div>
